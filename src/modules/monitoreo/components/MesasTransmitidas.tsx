...
const MesaTransmitidas = () => {
    ...
    return (
        <div className='mx-auto p-4'>
            <h3 className='text-center text-lg font-semibold text-gray-800 mb-4'>DETALLE DE MESAS TRANSMITIDAS (*)</h3>
            ...
            <div className='grid grid-cols-6 md:grid-cols-8 lg:grid-cols-10 gap-1'>
                {mesasActuales.map((mesa, index) => (
                    <div
                        ...
                        key={index}
                        className='border border-emerald-500 p-2 text-center text-blue font-medium hover:bg-emerald-500 hover:text-white cursor-pointer'>
                        {mesa}
                    </div>
                ))}
            </div>
            ...
            <Modal isOpen={viewModal === VIEWS_MODAL.popUpMesaTransmitidas && isOpenModal} onClose={CloseModal}>
                <div className='bg-white w-full mx-auto w-[1000px] py-10 flex flex-col items-center px-10 relative'>
                    ...
                    <p className='text-blue text-1xl font-semibold text-center mb-4'>
                        DETALLE DE ACTAS TRANSMITIDAS DE LA MESA <br />
...
export default MesaTransmitidas
