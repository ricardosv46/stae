...
export const EditIcon2 = (props: SVGProps<SVGSVGElement>) => {
    ...
    if (!fill) fill = "#7EC04E"
return <svg width="24" height="24" viewBox="0 0 24 24" {...props} fill="none" xmlns="http://www.w3.org/2000/svg"  className={`${className} inline-block ml-1 mr-1`}>
