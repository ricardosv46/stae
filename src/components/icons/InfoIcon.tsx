...
export const InfoIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" className="inline-block m-1 mt-0.5" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_2139_8041)">
      <path
